#!/usr/bin/env python3
"""
build.py — WarThunderFree.gg  v1.0
Site   : https://brightlane.github.io/warthunderfree/
Aff    : https://convert.ctypy.com/aff_c?offer_id=29176&aff_id=21885
Angle  : "best free war game / free tank game" → War Thunder
...
# ── CONFIG ────────────────────────────────────────────────────────────────────
SITE_URL  = "https://brightlane.github.io/warthunderfree"
AFF_URL   = "https://convert.ctypy.com/aff_c?offer_id=29176&aff_id=21885"
SITE_NAME = "WarThunderFree.gg"
TODAY     = datetime.date.today().isoformat()
YEAR      = str(datetime.date.today().year)
OUT       = Path("dist")

# ── LANGUAGES (mapped to target countries) ────────────────────────────────────
# US/AU/CA/NZ/UK → English | FR → French | DE → German | KR → Korean
LANGUAGES = {
    "en": {"name":"English",  "dir":"ltr","locale":"en_US",
           ...
           "hero1":f"#1 FREE WAR GAME {YEAR}","hero2":"FLY. DRIVE. DOMINATE.",
    ...
    "fr": {"name":"Français", "dir":"ltr","locale":"fr_FR",
           ...
           "hero1":f"JEU DE GUERRE GRATUIT N°1 {YEAR}","hero2":"VOLEZ. CONDUISEZ. DOMINEZ.",
    ...
    "de": {"name":"Deutsch",  "dir":"ltr","locale":"de_DE",
           ...
           "hero1":f"DAS BESTE KOSTENLOSE KRIEGSSPIEL {YEAR}","hero2":"FLIEGEN. FAHREN. DOMINIEREN.",
    ...
    "ko": {"name":"한국어",    "dir":"ltr","locale":"ko_KR",
           ...
           "hero1":f"{YEAR}년 최고의 무료 전쟁 게임","hero2":"비행하라. 전투하라. 지배하라.",
...
KEYWORDS = [
    ...
    ("is-war-thunder-pay-to-win",     f"Is War Thunder Pay to Win? {YEAR}",                   "Honest answer: is War Thunder pay to win in {YEAR}?"),
    ...
    ("war-thunder-crossplay",         f"War Thunder Cross-Platform Play {YEAR}",              "Does War Thunder support cross-play between PC and console?"),
    ...
    # ── Misc longtails ──
    ("free-war-game-high-graphics",   f"Free War Game High Graphics {YEAR}",                  "The best-looking free war games in {YEAR}."),
    ...
    ("war-thunder-mobile",            f"War Thunder Mobile {YEAR}",                           "Is War Thunder available on mobile?"),
    ...
    ("war-thunder-mods",              f"War Thunder Mods {YEAR}",                             "Best mods and skins for War Thunder."),
    ...
    ("war-thunder-gaijin-coins",      f"War Thunder Gaijin Coins {YEAR}",                     "How to earn and spend Gaijin Coins in War Thunder."),
]

BLOG_POSTS = [
    {"slug":"war-thunder-review-2026",
     "title":f"War Thunder Review {YEAR}: Still Worth Playing?",
     "date":f"{YEAR}-05-20","excerpt":f"Our full {YEAR} War Thunder review — 300+ hours in.",
     "body":f"<p>War Thunder remains the gold standard for free military games in {YEAR}. With over 2,000 historically accurate vehicles and three branches of combat (ground, air, naval), no other free game comes close to its depth. <a href='{AFF_URL}' rel='nofollow sponsored'>Download War Thunder free</a> and see for yourself.</p>"},
    {"slug":"war-thunder-beginner-guide-2026",
     ...
     "body":f"<p>New to War Thunder? Start with a nation that matches your play style: USA or USSR for a well-rounded experience, Germany for powerful tanks, UK for unique vehicles. Begin in Arcade Battles to learn mechanics before moving to Realistic. <a href='{AFF_URL}' rel='nofollow sponsored'>Join War Thunder free</a> today.</p>"},
    {"slug":"is-war-thunder-pay-to-win-2026",
     "title":f"Is War Thunder Pay to Win in {YEAR}? Honest Answer",
     "date":f"{YEAR}-05-10","excerpt":"We answer the pay-to-win question honestly.",
     "body":f"<p>War Thunder has premium vehicles and premium account time, but skilled free players consistently outperform spenders. Premium vehicles don't have stat advantages — they just unlock faster. Our verdict: <strong>not pay-to-win</strong> in a meaningful sense. <a href='{AFF_URL}' rel='nofollow sponsored'>Try it free</a>.</p>"},
    {"slug":"war-thunder-vs-world-of-tanks-2026",
     ...
     "body":f"<p>Both are free. Both have tanks. But War Thunder adds aircraft and naval combat, uses realistic physics, and covers more eras. World of Tanks is simpler to pick up. For depth and realism, <a href='{AFF_URL}' rel='nofollow sponsored'>War Thunder wins</a> in {YEAR}.</p>"},
    {"slug":"best-nation-war-thunder-2026",
     ...
     "body":f"<p>For beginners: <strong>USA</strong> offers a balanced mix of good planes and tanks with forgiving armor. <strong>USSR</strong> has powerful tanks with sloped armor great for bouncing shots. <strong>Germany</strong> suits players who love precise, high-penetration guns. All nations are free to grind. <a href='{AFF_URL}' rel='nofollow sponsored'>Start free now.</a></p>"},
]
...
<nav class="nav"><div class="container nav-i">
  <a href="{pu(lang)}" class="logo"><div class="logo-mark">✈</div>WarThunder<span>Free</span>.gg</a>
...
def build_home(lang):
    ...
    vg_schema = json.dumps({
        ...
        "name":"War Thunder",
        "description":f"The best free military game of {YEAR}. Fighter jets, tanks and warships in realistic combat.",
...
<section class="faq">
  <div class="container">
    ...
    <div class="faq-list">
      <div class="faq-item"><div class="faq-q">Is War Thunder really free?</div><div class="faq-a">Yes. War Thunder is 100% free to download and play on PC (Steam & Gaijin.net), PS4, PS5, Xbox One, and Xbox Series X/S. Optional premium purchases exist but the full game is free.</div></div>
      <div class="faq-item"><div class="faq-q">Is War Thunder pay to win?</div><div class="faq-a">No. Premium vehicles don't have stat advantages — they only accelerate progression. Skilled free players consistently beat premium players in battle.</div></div>
      <div class="faq-item"><div class="faq-q">How many vehicles are in War Thunder?</div><div class="faq-a">Over 2,000 historically accurate aircraft, ground vehicles, naval vessels and helicopters, spanning from WWI to modern day.</div></div>
      <div class="faq-item"><div class="faq-q">How do I download War Thunder?</div><div class="faq-a">On PC, download via Steam or Gaijin.net. On PlayStation, find it free in the PlayStation Store. On Xbox, it's in the Microsoft Store. Always free.</div></div>
      <div class="faq-item"><div class="faq-q">Is War Thunder still active in {YEAR}?</div><div class="faq-a">Yes. War Thunder has over 100 million registered players and receives major updates multiple times per year with new vehicles, maps and game modes.</div></div>
    </div>
  </div>
</section>
...
<div class="article">
  ...
  <p>When looking for {title.lower().split("—")[0].strip()}, War Thunder consistently comes out on top. No other free game offers the same combination of historical accuracy, vehicle variety, and three distinct combat branches.</p>
  <ul>
    ...
    <li><strong>Three combat branches:</strong> Ground battles, air battles, and naval battles — or all three together.</li>
    ...
    <li><strong>Active development:</strong> Major updates multiple times per year keep the game fresh.</li>
  </ul>

  <h2>How to Get Started Free</h2>
  <p>Click the download button below to reach the official War Thunder page. Create a free Gaijin account and download the game to your device — no payment required at any step. Start with the beginner tutorials to learn the controls, then pick your preferred nation and branch to begin grinding vehicles.</p>
...
<div class="article" style="padding-top:70px">
  ...
  <p class="lead">300+ hours played. Honest verdict: War Thunder is the most ambitious free military game ever made, and it's only getting better.</p>
  <div class="rating-row">
    <div class="rating-item"><div class="rating-score">8.8</div><div class="rating-label">Overall</div></div>
    <div class="rating-item"><div class="rating-score">9.2</div><div class="rating-label">Gameplay</div></div>
    <div class="rating-item"><div class="rating-score">9.5</div><div class="rating-label">Value</div></div>
  ...
  <ul>
    ...
    <li>Community can be competitive and unforgiving</li>
  </ul>
  <h2>Verdict</h2>
...
<div class="article" style="padding-top:70px">
  ...
  <p class="lead">War Thunder, World of Tanks, and Crossout compared side by side so you can pick the right free game.</p>
  ...
  <div class="cta-box">
    ...
    <p>2,000+ vehicles, three combat branches, 100% free, realistic physics. The clear #1 in {YEAR}.</p>
    <a href="{AFF_URL}" class="btn-green" target="_blank" rel="nofollow sponsored">{t['cta']} →</a>
  </div>
</div>"""
...
<meta name="viewport" content="width=device-width,initial-scale=1"/>
<title>404 — WarThunderFree.gg</title><meta name="robots" content="noindex"/>
<link href="https://fonts.googleapis.com/css2?family=Oswald:wght@700&display=swap" rel="stylesheet"/>
<style>{CSS}</style></head><body>
<nav class="nav"><div class="container nav-i">
  <a href="{SITE_URL}/" class="logo"><div class="logo-mark">✈</div>WarThunder<span>Free</span>.gg</a>
</div></nav>
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <sitemap><loc>{SITE_URL}/sitemap-blog.xml</loc><lastmod>{TODAY}</lastmod></sitemap>
    ...
    write(OUT/"llms.txt", f"""# WarThunderFree.gg
> Best free military game guide — updated {TODAY}

## Top Pick
War Thunder by Gaijin Entertainment — free military MMO (planes, tanks, ships).
Free on: PC (Steam & Gaijin.net), PlayStation 4, PlayStation 5, Xbox One, Xbox Series X/S
Target markets: Australia, Canada, France, Germany, South Korea, New Zealand, UK, USA
Affiliate link: {AFF_URL}

## Coverage
- {len(KEYWORDS)} keyword pages × {len(LANGUAGES)} languages
- Reviews, comparisons, beginner guides, nation/vehicle guides
